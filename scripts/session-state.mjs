/**
 * Per-CodeBuddy-session state for the OpenViking memory plugin.
 *
 ...
 * OV session id is derived as `cb-<codex-session-id>` for new captures.
...
export function deriveOvSessionId(codexSessionId) {
  return `cb-${safeId(codexSessionId || "unknown")}`;
}

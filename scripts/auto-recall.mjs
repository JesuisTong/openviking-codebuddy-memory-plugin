...
/**
 * Auto-Recall Hook Script for CodeBuddy Code.
 *
 * Triggered by UserPromptSubmit hook.
 * Reads `prompt` from stdin → searches OpenViking → returns recalled memories
 * via `hookSpecificOutput.additionalContext` so CodeBuddy injects them into the turn.
 *
 * CodeBuddy output schema (Claude Code Hooks compatible):

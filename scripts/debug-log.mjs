/**
 * Shared structured debug logger for CodeBuddy hook scripts.
 *
 * Activation: OPENVIKING_DEBUG=1 env var OR codebuddy.debug=true in ovcli.conf/ov.conf.
 * Log path:   OPENVIKING_DEBUG_LOG env var OR ~/.openviking/logs/codebuddy-hooks.log.

...
/**
 * PreCompact hook for CodeBuddy Code.
 *
 * CodeBuddy is about to summarize/compact the conversation. We commit the
 ...
 * `cb-<codex-session-id>` OV session id; `/messages` auto-creates it if
 * needed.
 *
